...
async function generateAndSharePdf(
  ...
  doc.setFontSize(22);
  doc.text('SiteScope AI', margin, 18);

  doc.setTextColor(255, 255, 255);
  doc.setFontSize(10);
  doc.setFont('helvetica', 'normal');
  doc.text('Website UX Audit Report', margin, 27);
  ...
  const fileName =
    `sitescope-ai-${safeName}-audit-${Date.now()}.pdf`;
  ...
  await Share.share({
    title: 'SiteScope AI Audit Report',
    text: `SiteScope AI website UX audit for ${url}`,
    url: savedFile.uri,
...
export default function App() {
  ...
  /* -------------------------------------------------------------- */
  /* Load recent audits using Supabase client                      */
  /* -------------------------------------------------------------- */
